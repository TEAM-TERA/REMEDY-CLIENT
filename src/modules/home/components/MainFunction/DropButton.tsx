...
import Svg, { Circle, Path, Defs, Filter, FeFlood, FeColorMatrix, FeOffset, FeGaussianBlur, FeComposite, FeBlend } from 'react-native-svg';
  ...
  return (
    ...
    >
      <Svg width="120" height="112" viewBox="0 0 120 112" fill="none">
        <Defs>
          <Filter id="filter0_d_3451_19862" x="0" y="0" width="180" height="180" filterUnits="userSpaceOnUse">
            ...
            <FeBlend mode="normal" in2="BackgroundImageFix" result="effect1_dropShadow_3451_19862"/>
            <FeBlend mode="normal" in="SourceGraphic" in2="effect1_dropShadow_3451_19862" result="shape"/>
          </Filter>
        </Defs>
        
        <Circle cx="90" cy="90" r="70" fill="#F3124E" filter="url(#filter0_d_3451_19862)"/>
