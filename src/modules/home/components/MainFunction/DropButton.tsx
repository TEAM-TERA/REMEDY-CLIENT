...
import Svg, { G, Circle, Path, Defs, Filter, FeFlood, FeColorMatrix, FeOffset, FeGaussianBlur, FeComposite, FeBlend, RadialGradient, Stop } from 'react-native-svg';
...
export default function DropButton({ onPress, isCancel = false }: Props) {
  return (
    <Pressable
      accessibilityRole="button"
      accessibilityLabel={isCancel ? "Cancel drop" : "Drop music"}
      onPress={onPress}
    ...
    >
      {isCancel ? (
        ...
        <Svg width="120" height="112" viewBox="0 0 120 112" fill="none">
          <Defs>
            <RadialGradient id="cancelGrad" cx="90" cy="90" rx="70" ry="70" gradientUnits="userSpaceOnUse">
              <Stop offset="0" stopColor="#8B8B8B" stopOpacity="1" />
              <Stop offset="0.6" stopColor="#8B8B8B" stopOpacity="0.6" />
              <Stop offset="1" stopColor="#8B8B8B" stopOpacity="0" />
            </RadialGradient>
          </Defs>
          <G transform="translate(-22,-22)">
            <Circle cx="90" cy="90" r="84" fill="url(#cancelGrad)" />
            <Circle cx="90" cy="90" r="66" fill="#8B8B8B" />
            {/* X 아이콘 */}
            <Path d="M76 76L104 104M104 76L76 104" stroke="white" strokeWidth="4" strokeLinecap="round"/>
          </G>
        </Svg>
      ) : (
        // 기존 DROP 버튼 렌더링
        <Svg width="120" height="112" viewBox="0 0 120 112" fill="none">
          <Defs>
            <RadialGradient id="dropGrad" cx="90" cy="90" rx="70" ry="70" gradientUnits="userSpaceOnUse">
              <Stop offset="0" stopColor="#F3124E" stopOpacity="1" />
              <Stop offset="0.6" stopColor="#F3124E" stopOpacity="0.6" />
              <Stop offset="1" stopColor="#F3124E" stopOpacity="0" />
            </RadialGradient>
          </Defs>
          <G transform="translate(-22,-22)">
            <Circle cx="90" cy="90" r="84" fill="url(#dropGrad)" />
            <Circle cx="90" cy="90" r="66" fill="#F3124E" />
